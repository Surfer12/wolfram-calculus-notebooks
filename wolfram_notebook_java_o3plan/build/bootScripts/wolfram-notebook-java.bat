...
set JARPATH=%APP_HOME%\lib\wolfram-notebook-java.jar

@rem Execute wolfram-notebook-java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WOLFRAM_NOTEBOOK_JAVA_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%WOLFRAM_NOTEBOOK_JAVA_EXIT_CONSOLE%" exit 1
exit /b 1
